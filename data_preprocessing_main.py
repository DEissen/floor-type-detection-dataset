...
def data_preprocessing_main(dataset_path, config_dict):
    """
    ...
    for root, dirs, files in os.walk(dataset_path):
        for sensor in dirs:
            if "Cam" in sensor:
                preprocess_images_for_camera(dataset_path, sensor, config_dict)
            else:
                preprocess_timeseries_data(dataset_path, sensor, config_dict)


def preprocess_images_for_camera(dataset_path, camera_name, config_dict, plot_preprocessing_once=False):
    """
